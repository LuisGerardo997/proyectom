  ...
  <div class="modal fade" id="editar" tabindex="-1" role="dialog">
                                          ...
                                          <div class="form-group form-float">
                                              <div class="form-line focused">
                                                <label class="form-label">Tipo de habitación</label>
                                                  <input type="text" name="Tipo_habitacion" id="tipo_habitacion" class="form-control">
                                              </div>
                                          </div>
                                      </div>
                                      <div class="col-md-4">
      ...
      <div class="modal fade" id="crear" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title" id="largeModalLabel">Registro de Tipo de Habitación</h2>
                    </div>
                    <div class="modal-body">
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                          <label class="form-label">Tipo de habitación</label>
                                            <input type="text" name="tipo_habitacion_c" id="tipo_habitacion_c" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
