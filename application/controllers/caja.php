...
class Caja extends CI_Controller {
  function __construct(){
    ...
    public function consultar(){
        echo json_encode($this->Caja_model->consultar());
    }

    function actualizar(){
        $selector = $this->input->post('cod_caja');
        $cod_caja = $selector;
        $nro_caja = $this->input->post('nro_caja');
        ...
        if($this->Caja_model->actualizar($selector, $data) == true){
            echo '1';
        }
    ...
    function guardar(){
        ...
        if($this->Caja_model->guardar($data) == true){
            echo '1';
        }
