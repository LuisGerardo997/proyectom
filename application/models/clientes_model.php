...
class Clientes_model extends CI_Model{
  ...
  function consultar(){
    $this->db->select('p.cod_persona, p.nombres, p.apellido_paterno, p.apellido_materno, p.ruc, p.email, p.genero, p.tel_movil, u.ciudad, e.estado_civil, tp.tipo_persona');
