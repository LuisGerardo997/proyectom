                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div role="tabpanel" class="tab-pane animated flipInX" id="profile_animation_1">
                                                        <div class="col-md-10 col-md-offset-1">
                                                                ...
                                                                <hr>
                                                                <div class="body table-responsive" id="detalle">
        ...
        <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                                                        ...
                                                        <div class="row clearfix">
                                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                        ...
                                                                        <div class="tab-content">
                                                                                ...
                                                                                <div role="tabpanel" class="tab-pane animated flipInX" id="estadias">
                        ...
                        <div class="modal-footer">
                                        <button type="button" id="seleccion_detalle" class="btn btn-link waves-effect">Agregar selección</button>
                                        <button type="button" class="btn btn-link waves-effect">Cancelar</button>
                        </div>
                </div>
        </div>
</div>
