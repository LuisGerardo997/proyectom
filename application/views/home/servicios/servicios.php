                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focused">
                                            ...
                                            <input disabled type="number" name="cod_servicio" id="cod_servicio" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-float">
                                        <div class="form-line focused">
                                            ...
                                            <input type="text" name="servicio" id="servicio" class="form-control" maxlength="30">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <label class="form-label">Nombre del servicio</label>
                                            <input type="text" name="servicio_c" id="servicio_c" class="form-control" maxlength="30">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
