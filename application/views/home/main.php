                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="<?php base_url() ?>proveedores">
                            ...
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li><a href="<?php base_url() ?>tipo_productos">Tipo de producto</a></li>
                                    <li><a href="<?php base_url() ?>marca">Marca</a></li>
                                    <li><a href="<?php base_url() ?>producto">Producto</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="<?php base_url() ?>tipo_pago">
                                    <span>Tipos de Pago</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php base_url() ?>tipo_movimiento">
                                    <span>Tipos de Movimiento</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php base_url() ?>tipo_documento">
                            ...
                            <li>
                                <a href="<?php base_url() ?>tipo_transaccion">
                            ...
                            <li>
                                ...
                                <ul class="ml-menu"><li><a href="">Módulos</a></li>
                                    ...
                                    <li><a href="<?php base_url() ?>privilegios">Privilegios</a></li></ul>
                                </li>
                            </ul>
                        </li>
                        <li>
