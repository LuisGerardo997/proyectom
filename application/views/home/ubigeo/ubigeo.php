    ...
    <div class="container-fluid">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group form-float">
                                        ...
                                        <input type="text" name="ciudad" id="ciudad" class="form-control" maxlength="255">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-float">
                                        ...
                                        <input type="text" name="provincia" id="provincia" class="form-control" maxlength="20">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
        ...
        <div class="modal fade" id="crear" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title text-center" id="largeModalLabel">Registro de Ubigeo</h2>
                    </div>
                    <div class="modal-body">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                          <label class="form-label">Ciudad</label>
                                            <input type="text" name="ciudad_c" id="ciudad_c" class="form-control" maxlength="255">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                          <label class="form-label">Provincia</label>
                                            <input type="text" name="provincia_c" id="provincia_c" class="form-control" maxlength="20">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                          <label class="form-label">Departamento</label>
                                            <input type="text" name="departamento_c" id="departamento_c" class="form-control" maxlength="20">
                                        </div>
                                    </div>
                                </div>
                            </div>
