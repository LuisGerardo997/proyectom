...
<section class="content">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <ul class="nav nav-tabs tab-nav-right text-right" role="tablist">
                  <li role="presentation" id="ventas_realizadas" class="active">
                    <a href="#home_animation_1" data-toggle="tab">Ver reservaciones</a>
                  </li>
                  <li role="presentation" id="realizar_venta">
                    <a href="#profile_animation_1" data-toggle="tab">Nueva reservación</a>
                  </li>
                </ul>
                            ...
                            <section id="formulario">
                              ...
                              <form name="reservation_form">
                                ...
                                <form name="cliente_form" id="cliente_form">
                                  ...
                                  <div id="detalles"></div>
                                  <div id="btn_registrar" style='display:none'>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button class="btn btn-default waves-effect">
            <i class="material-icons">add</i>Nuevo cliente</button>
        </div>
        <div class="modal-body">
          <div class="row clearfix">
  ...
  <div class="modal fade" id="add_client" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <!-- <h2 class="modal-title text-center">Añadir huéspedes</h2>
          <button class="btn btn-default waves-effect">
